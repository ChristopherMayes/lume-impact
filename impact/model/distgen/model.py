...
class LUMEDistgenModel(LUMEModel):
    def __init__(
        self,
        gen: Any,
        actions: list[DistgenVarAction],
        dummy_run: bool = False,
    ):
        self.gen = gen
        self.actions = actions
        self._action_by_name: dict[str, DistgenVarAction] = {m.name: m for m in actions}
    ...
    def register_action(self, action: DistgenVarAction) -> None:
